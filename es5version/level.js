...
/*#__PURE__*/
function () {
  function Level(canvas, levelNumber) {
    ...
    /* horizontal top*/
    {
      ...
      dx: 476,
      dy: 198
    }, // top border right side after divider
    ...
    value: function draw() {
      ...
      if (this.levelNumber === 1) {
        this.level1.forEach(function (element) {
          ...
          _this.ctx.lineWidth = 1; //element.w;

          _this.ctx.moveTo(element.mx, element.my);

          _this.ctx.lineTo(element.dx, element.dy);
