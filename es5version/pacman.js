...
/*#__PURE__*/
function () {
  function PacMan(x, y, canvas, candyEatenCallback, pacManHitGhostCallback) {
  ...
  _createClass(PacMan, [{
    ...
    value: function draw() {
      ...
      if (this.direction) {
        if (this.isMouthClosing) {
          this.ctx.arc(this.x, this.y, this.pacManRadius, (arcStart - this.animationCounter) * Math.PI, (arcEnd + this.animationCounter) * Math.PI);
        } else {
        ...
        if (this.animationCounter >= this.animationMaxValue) {
          this.animationCounter = 0; // if (this.isMouthClosing) {
    ...
    key: "checkIfCanMove",
    value: function checkIfCanMove(direction) {
      var imageData = [];
      var pixelArray = [];
      var candyLoactionX = this.x;
      var candyLocationY = this.y; //ctx.getImageData(startCuX, startCutY, numberOfPixelsToCutX, numberOfPixelsToCutY;
      ...
      if (this.checkColor(250, 252, 182, pixelArray)) {
        ...
        return false;
      } else if (this.checkColor(255, 138, 170, pixelArray) || this.checkColor(36, 180, 237, pixelArray) || this.checkColor(244, 10, 29, pixelArray) || this.checkColor(244, 132, 3, pixelArray)) {
        // Ghost colors 
        //"rgb(255, 138, 170";
        // 'rgb(36, 180, 237'
        // 'rgb(244, 10, 29'
    ...
    key: "setWantedDirection",
    value: function setWantedDirection(newDirection) {
